...
inorder(btree)
print("\n levelorder Trversal: ")
print(levelorder(btree))
print("\nsearch for element 6:")
print("levelorder:",search_levelorder(btree, 6))
print("preorder:",search_preorder(btree, 6))
print("inorder:",search_inorder(btree, 6))
print("postorder:",search_postorder(btree, 68))
